...
async transcribeAudio(audioFile: Express.Multer.File) {
  ...
  async getRefinedText(
    ...
    try {
      const prompt = `Please Generates a full text rewriting the following text with a clear and concise explanation in the same language code ${languageCode}. Ensure the generated text is detailed. Do not exceed or fall short of this range. 
