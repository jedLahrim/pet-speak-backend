...
async transcribeAudio(audioFile: Express.Multer.File) {
  ...
  async getRefinedText(
    ...
    try {
      const prompt = `Please Generates a full text rewriting the following text with a clear and concise explanation in the same language code ${languageCode}. Ensure the generated text is not less than 300 characters. Do not exceed or fall short of this range. 
